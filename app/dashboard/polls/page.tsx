...
import { mockPollsPosts, mockUsers } from "@/lib/mock-data";
...
export default function CarouselsPage() {
  const carousels = mockPollsPosts
    .filter(post => post.type === "polls")
    .map(post => ({
      ...post,
  ...
  return (
    <div className="p-2 sm:p-8">
      <h1 className="text-2xl sm:pl-[50px] pl-[60px] font-bold sm:my-0 sm:mb-5 my-6">Polls Analytics</h1>
